...
* ProcessStarter -> config file with extensions and programs
* widget list editor of codecreator -> own widget?
* activate AStyle
* activate CodeCleaner
* ToolBox/Standalonde Generators for CodeCreator
* create program SvnIdRemover -> funtionality implemented in CppHelper
...
* CodeEdit add search functionality
