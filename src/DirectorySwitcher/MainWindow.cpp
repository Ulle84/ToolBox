...
{
  ui->setupUi(this);
  setWindowIcon(QIcon(":/images/view-refresh.png"));
...
void MainWindow::on_listWidgetProjects_currentTextChanged(const QString& currentText)
{
  ...
  m_currentSettingsFile = ui->lineEditBaseDirectory->text() + QDir::separator() + currentText + QDir::separator() + m_settingsFileName;
  updateInfo();
  updateSettings();
}
void MainWindow::on_pushButtonSaveInformation_clicked()
{
