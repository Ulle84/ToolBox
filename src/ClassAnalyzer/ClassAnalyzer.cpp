...
{
  m_classes.clear();
  m_numberOfClassesPerFile.clear();
...
QString ClassAnalyzer::allClasses()
{
  QString string;
  ...
  string.append(QString("found %1 classes\n\n").arg(m_classes.size()));

  return string;
}

QString ClassAnalyzer::filesWithMoreThanOneClassDeclaration()
{
  QString string;
