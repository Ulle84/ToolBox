...
QString GeneratorDecorator::integrationInstructions()
{
  return QString();
}

QList<QPair<QString, QString>> GeneratorDecorator::additionalResources()
{
  return QList<QPair<QString, QString>>();
}

QString GeneratorDecorator::directory()
{
  return QString();
}
