...
QString GeneratorAbstractFactory::integrationInstructions()
{
  return QString();
}

QList<QPair<QString, QString>> GeneratorAbstractFactory::additionalResources()
{
  return QList<QPair<QString, QString>>();
}

QString GeneratorAbstractFactory::directory()
{
  return QString();
}
