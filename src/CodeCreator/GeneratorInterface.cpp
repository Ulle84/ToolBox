...
QString GeneratorInterface::integrationInstructions()
{
  return QString();
}

QList<QPair<QString, QString>> GeneratorInterface::additionalResources()
{
  return QList<QPair<QString, QString>>();
}

QString GeneratorInterface::directory()
{
  return QString();
}
