...
// TODO make applicable for a whole file
// * read file-conent
// * split file-content by '\n'
// * analyse complete file and find blocks, which need to be formated: QList<QPair<uint /*startLineNumber*/, uint /*endLineNumber*/> >
// * replace lines between startLineNumber and endLineNumber -> see code below
